...
- Alternatively, place the original base ROM and the IPS file in the same folder and name them both the same thing: i.e, "Antinomia_FF6_Unheadered.ips" and "Antinomia_FF6_Unheadered.smc".  Many emulators such as SNES9x will automatically combine the files when the base ROM is loaded.
