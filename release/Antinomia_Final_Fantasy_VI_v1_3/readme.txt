Antinomia: Final Fantasy VI - v1.3 - Fast Moon
...
- Base ROM: Final Fantasy III (U) (V1.0).  You are responsible for finding this yourself. Compatible with the 1.0 base ROM only. Will softlock during battle dialogue if you use the 1.1 ROM. Please note the checksum to make sure you have the right one.
...
- Leo does not return to the party line after executing his desperation attack.  May fix later.
